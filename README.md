# command_line_notiz  [v1.2] [https://github.com/leva84/command_line_notiz]
...
## Назначение
 ...
 - Программу возможно использовать в любых проектак Ruby,
  для тестирования кода и обкатки часто повторяющегося кода
...
## Использование
  - Запустить программу `ruby main.rb` либо `ruby /path_to/main.rb ` если запуск программы происходит не из домашней директории.
  ...
  - `about` запросить данное описание в консоли
